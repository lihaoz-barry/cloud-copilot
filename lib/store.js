  ...
  for (const n of issueNumbers) {
    ...
    out[n] = {
      ...
      prs: prsArray(record).map((p) => ({
        ...
        // Only the completed-review marker is exposed here: the list needs it
        // to decide whether a merged PR also went through review (issue #68),
        // and nothing else about a review belongs in a status sweep payload.
        review: {
          lastReviewedSha: (p.review && p.review.lastReviewedSha) || null,
        },
        deploy: {
